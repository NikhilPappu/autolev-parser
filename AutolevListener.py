...
class AutolevListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by AutolevParser#assignment.
    def enterAssignment(self, ctx:AutolevParser.AssignmentContext):
        pass

    # Exit a parse tree produced by AutolevParser#assignment.
    def exitAssignment(self, ctx:AutolevParser.AssignmentContext):
        pass
